...
import {addQuestions, getQuestions, addQuestionsTest, examType} from "./api/addQuestions"
import {getSubject} from "./api/subject"
import {getfilterQuestions} from "./api/filterQuestions"
import {getUserList, getApiInterfaceList, getRelationshipList, getviewAauthorityList, getvaRelationList, addUser, putUser, addIdentity, addauthorityApi, authorityView, setIdentityApi, setIdentityView, getIdentity, getUserInfo } from "./api/user"
import {getTestList, createTest, questionsUpdate} from "./api/testQuestions"
...
//创建试题的接口
Vue.prototype.$createTest = createTest;
//添加试题的接口
Vue.prototype.$addQuestionsTest = addQuestionsTest;
//获取所有考试类型的接口
Vue.prototype.$examType = examType;
//获取当前用户信息的接口
Vue.prototype.$getUserInfo = getUserInfo;
//更新试题的接口
Vue.prototype.$questionsUpdate = questionsUpdate;
